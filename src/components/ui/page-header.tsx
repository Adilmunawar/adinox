...
export const PageHeader = ({
  ...
  return <header className={cn("flex flex-col space-y-3 mb-8", className)}>
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          {showAuth && user && <SlideIn direction="right" delay={0.2} duration={0.6}>
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  ...
                  duration: 0.3
                    ...
                    <motion.div className="absolute -top-1 -right-1 w-2.5 h-2.5 bg-primary rounded-full" animate={{
                  scale: [1, 1.2, 1],
                  opacity: [0.7, 1, 0.7]
                }} transition={{
                  duration: 2,
      ...
      {(title || description) && <div className="space-y-1">
          {title}
          {description && <FadeIn delay={0.4} direction="up">
